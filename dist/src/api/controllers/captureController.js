...
const pdfProcessing_1 = require("../../trigger/pdfProcessing");
...
const saveCapture = async (req, res) => {
    ...
    try {
        ...
        if (isPdf) {
            await pdfProcessing_1.pdfProcessing.trigger({
                captureId: ((_c = capture._id) === null || _c === void 0 ? void 0 : _c.toString()) || "",
                url: capture.url,
            });
        }
        else {
            ...
            await aiProcessing_1.aiProcessing.trigger({
                captureId: ((_d = capture._id) === null || _d === void 0 ? void 0 : _d.toString()) || "",
                userId: ((_e = capture.owner) === null || _e === void 0 ? void 0 : _e.toString()) || "",
            });
            await embeddingProcessing_1.embeddingProcessing.trigger({
                captureId: ((_f = capture._id) === null || _f === void 0 ? void 0 : _f.toString()) || "",
                userId: ((_g = capture.owner) === null || _g === void 0 ? void 0 : _g.toString()) || "",
...
const deleteCapture = async (req, res) => {
    ...
    try {
        ...
        await embeddingProcessing_1.embeddingProcessing.trigger({
            captureId: ((_a = capture === null || capture === void 0 ? void 0 : capture._id) === null || _a === void 0 ? void 0 : _a.toString()) || "",
            userId: req.user.id,
            taskType: embeddingProcessing_1.EmbeddingTaskType.DELETE,
        });
...
const reProcessCapture = async (req, res) => {
    ...
    try {
        ...
        if (capture.metadata.isPdf) {
            ...
            await pdfProcessing_1.pdfProcessing.trigger({
                captureId: ((_a = capture._id) === null || _a === void 0 ? void 0 : _a.toString()) || "",
                url: capture.url,
            });
            ...
            capture.processingStatus = "processing";
            await aiProcessing_1.aiProcessing.trigger({
                captureId: ((_b = capture._id) === null || _b === void 0 ? void 0 : _b.toString()) || "",
