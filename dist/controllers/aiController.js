...
class AIController {
    ...
    static async chat(req, res) {
        ...
        try {
            ...
            logger_1.logger.info(`${SERVICE_NAME}:converse:stream:start`, { captureId, model });
            ...
            const err = error;
            logger_1.logger.error(`${SERVICE_NAME}:converse:stream:error`, { name: err.name, message: err.message });
